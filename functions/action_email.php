...
class action_email 
{
        function email_send ($email_to, $title = "", $content = "") {
                ...
                $mFrom = 'example@gmail.com';  //dia chi email cua ban 
        ...
        function lien_he () {
            global $conn_vn;
                if (isset($_POST['lien_he'])) {
                        ...
                        echo '<script type="text/javascript">alert(\'Cảm ơn Khách hàng đã quan tâm tới sản phẩm và dịch vụ của Công ty chúng tôi, nhân viên kinh doanh của UniEco sẽ phản hồi tới Quý Khách trong thời gian sớm nhất.\');</script>';
                }
        }
