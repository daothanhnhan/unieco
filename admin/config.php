                            ...
                            <?php 
                                ...
                                ?>
                                    <div role="tabpanel" class="tab-pane <?= $key == 0 ? 'active' : ''?>" id="<?= $lang['languages_code']?>">
                                        ...
                                        <input type="text" class="txtNCP1" name="lang[<?= $lang['languages_code']?>][lang_web_name]" value="<?= $rowDetailLang['lang_web_name'];?>">
                                        <p class="titleRightNCP">Keyword</p>
                                        <input type="text" class="txtNCP1" name="lang[<?= $lang['languages_code']?>][lang_web_keyword]" value="<?= $rowDetailLang['lang_web_keyword'];?>">
                                        <p class="titleRightNCP">Meta Description:</p>
                                        <textarea name="lang[<?= $lang['languages_code']?>][lang_web_des]" id="input" class="form-control" rows="3"><?= $rowDetailLang['lang_web_des'];?></textarea>
                                        <p class="titleRightNCP">Giới thiệu công ty - thay thế vị trí chân trang</p>
                                        <textarea name="lang[<?= $lang['languages_code']?>][lang_web_email]" id="input" class="form-control" rows="3"><?= $rowDetailLang['lang_web_email'];?></textarea>
...
<form action="" method="post" enctype="multipart/form-data" id="updateConfig">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <p class="titleRightNCP">Địa chỉ liên hệ 2</p>
