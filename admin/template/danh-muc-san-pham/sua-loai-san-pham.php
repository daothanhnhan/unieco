                            ...
                            <?php 
                                ...
                                ?>
                                    <div role="tabpanel" class="tab-pane <?= $key == 0 ? 'active' : ''?>" id="<?= $lang['languages_code']?>">
                                        ...
                                        <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP1 ckeditor" id="editor1<?= $lang['languages_code']?>" name="lang[<?= $lang['languages_code']?>][lang_productcat_des]" ><?= $rowDetailLang['lang_productcat_des'];?></textarea></p>
                                        <p class="titleRightNCP">Chi tiết</p> 
                                        <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP1 ckeditor" id="editor2<?= $lang['languages_code']?>" name="lang[<?= $lang['languages_code']?>][lang_productcat_content]" ><?= $rowDetailLang['lang_productcat_content'];?></textarea></p>
